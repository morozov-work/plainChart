import injectStyle from './services/injectStyle.js';
...
class PlainChart {
    constructor(parent, data = 'no data') {
        this.parent = parent;
        ...
        //=======================================================
        if(data === 'no data') {
            console.log('create new chart no data');
            return;
        }

        const {type = '', values = '', labels = '', settings = {} } = data;

        if(!type || !values || !labels ||
            values.split(',').length !== 
            labels.split(',').length
            ) {
                console.log('create new chart no val');
                return;
            }
        //==========================================================
